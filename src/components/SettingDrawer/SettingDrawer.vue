      ...
      <div class="setting-drawer-index-content">
            ...
            <a-list :split="false">
              <a-list-item>
                <a-tooltip slot="actions">
                  <template slot="title">
                    This setting is valid only when [Top Bar]
                  </template>
              ...
              <a-list-item>
                ...
                <a-list-item-meta>
                  <a-tooltip slot="title" placement="left">
                    <template slot="title">Configurable when fixed Header</template>
                    <div :style="{ opacity: !fixedHeader ? '0.5' : '1' }">Hidden when falling Header</div>
                  </a-tooltip>
                </a-list-item-meta>
              </a-list-item>
              <a-list-item >
          ...
          <div>
            <a-list :split="false">
              ...
              <a-list-item>
                ...
                <a-list-item-meta>
                  <div slot="title">MultiTab MODE</div>
                </a-list-item-meta>
              </a-list-item>
            </a-list>
          </div>
        ...
        <div :style="{ marginBottom: '24px' }">
          ...
          <a-alert type="warning" :style="{ marginTop: '24px' }">
            <span slot="message">
              The configuration bar is only used in the development environment for preview, the production environment will not be displayed, please manually modify the configuration file.
